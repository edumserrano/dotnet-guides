...
{
    // Demo how to test using a Custom WebApplicationFactory<T> implementation
    // See https://docs.microsoft.com/en-us/aspnet/core/test/integration-tests?view=aspnetcore-5.0#customize-webapplicationfactory
    ...
    public class DemoTests2 : IClassFixture<TestingLogsWithSerilogDemoWebApplicationFactory>
    {
        private readonly WebApplicationFactory<Startup> _webApplicationFactory;

        public DemoTests2(TestingLogsWithSerilogDemoWebApplicationFactory webApplicationFactory)
        {
